...
class RotationAnimation : aniray::NodeAnimation<NodeArrayT> {
   ...
   public:
    RotationAnimation(NodeArrayT& nodeArray,
                      Point origin,
                      double pathRadius,
                      double sphereRadius,
    ...
    void frame(double milliseconds) override {
        ...
        double angle = (std::fmod(milliseconds, mPeriodMilliseconds) /
                        mPeriodMilliseconds) *
    ...
    void draw() {
        ...
        cinder::gl::drawSphere(
            glm::vec3(mCurrentPosition.x(), mCurrentPosition.y(),
                      mCurrentPosition.z()),
            mSphereRadius, 30);
